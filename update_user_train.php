...
if (isset($_GET['kd_user'])) {
    ...
    $data_user = mysqli_query($con, $query);
    ...
    if ($data_user) {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($old_password != $q_user['passwordx']) {
                echo "
                    <script>
                        alert('Old Password Salah');
                        window.location.href = 'update_user_train.php?kd_user=$kd_user';
                    </script>
                ";
                exit();
            }
            ...
            $update_query = "UPDATE tc_tb_user SET nm_user='$nama_user', kd_level='$kd_level', password='$hash_password',passwordx='$konf_password' WHERE kd_user='$kd_user'";
            ...
            if ($result) {
                echo "
                    <script>
                        ...
                        window.location.href = 'user_train_checker.php';
                    </script>
                ";
                exit();
            } else {
...
<head>
    ...
    <title>Update -User Train Checker</title>
                            ...
                            <div class="p-3 pb-4 pt-4">
                                ...
                                <form method="POST">
                                    ...
                                    <input type="text" name="kd_level" class="form-control" value="<?php echo $q_user['nm_level']; ?>" readonly /> -->
                                        ...
                                        <input type="text" name="old_password" class="form-control" value="<?php echo $q_user['passwordx'] ?>" />
                                        <br>
                                    ...
                                    <a <button href="user_train_checker.php" type="submit" class="btn btn-danger">Kembali</button> </a>
